        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-zinc-400">
              Request a free estimate for your commercial or industrial concrete project in Cincinnati, OH, Northern KY, or SE Indiana. Call or email us directly — we respond within 24 business hours.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-zinc-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto space-y-6">
              ...
              href="tel:5136732888"
              className="flex items-start gap-4 p-6 bg-white rounded-lg hover:shadow-md transition-shadow group"
            >
